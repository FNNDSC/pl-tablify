...
PLUGIN_TITLE='A ChRIS plugin to generate interactive tables from structured data files. '
SCRIPT_NAME='tablify'
DESCRIPTION='A ChRIS plugin to generate interactive tables from structured data files.'
ORGANIZATION='FNNDSC'
